...
def generate_story(jsonl_path: str, force: bool = False, language: str = None) -> str | None:
    ...
    prompt = (
        ...
        "minimum. Avoid esoteric characters like '→'. Divide the story into small chapters, "
        "and make it an interesting read for a developer. Start with the heading "
        ...
        "\n"
        "Make the following transformations for better readability in text-to-speech:\n"
        "- codebase => code base\n"
        "- file paths like /home/user/project/file.py => file-dot-py in project\n"
        "\n"
        "<session_events>\n"
        f"{events_txt}"
        "\n\n</session_events>\n"
